...
onload = function init()  {
    ...
    // Event listener for mousewheel
     ...
     this.window.addEventListener("keydown", function(e){
        switch(e.keyCode){
            case 37:
                lightPosition = add(lightPosition,vec4(0.1,0,0,0));
                makeLight();
                break;
                //vinstri ör
            case 39:
                ...
                //hægri ör
            case 38:
                lightPosition = add(lightPosition,vec4(0,0.1,0,0));
                makeLight();
                break;
                //upp ör
            case 40:
        ...
        //keyCode aðferðin er deprecated, en gerir okkur kleift að gera frekar einfaldan reikning.
        if(e.keyCode>48&&e.keyCode<58){
            changeTeapot(e.keyCode-48);
        }
     })
...
/**
 * endurstillir bufferana okkar út frá nýjum teapot hlut.
 * @param i er tala 
 */
function changeTeapot(i){
    var myTeapot = teapot(i);
    myTeapot.scale(0.5, 0.5, 0.5);
