...
window.onload = function init() {
    ...
    gl.uniform1f(gl.getUniformLocation(program, "growthSpeed"),growthSpeed);
     ...
     window.addEventListener("keydown", function(e){
        switch(e.key){
            case "ArrowLeft":
                ...
                break;
            case "ArrowRight":
                maxBright = Math.max(0,maxBright -0.2);
                gl.uniform1f( gl.getUniformLocation(program, "maxBright"), maxBright);
                break;
            case "ArrowUp":
                growthSpeed = Math.min(1,growthSpeed * 2);
                gl.uniform1f(gl.getUniformLocation(program, "growthSpeed"),growthSpeed);
                break;
            case "ArrowDown":
                growthSpeed = Math.max(0.0000001, growthSpeed*0.5);
                gl.uniform1f(gl.getUniformLocation(program, "growthSpeed"),growthSpeed);
                break;
        }
     })
